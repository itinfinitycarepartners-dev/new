...
// CHANGE: Use HashRouter instead of BrowserRouter
...
import { initMessaging, websocket, tokenStorage } from '@/api/icpClient';
...
const AuthenticatedApp = () => {
  ...
  return (
    <Routes>
      ...
      {/* Admin Route - Works with HashRouter */}
      ...
      <Route element={<ProtectedRoute />}>
        <Route element={<Layout />}>
          ...
          <Route path="/welcome-packet" element={<WelcomePacket />} />
          <Route path="/relocation" element={<RelocationHub />} />
          <Route path="/pipeline" element={<Pipeline />} />
          <Route path="/aftercare" element={<Aftercare />} />
          <Route path="/resource" element={<Resource />} />
          <Route path="/randl" element={<RAndL />} />
